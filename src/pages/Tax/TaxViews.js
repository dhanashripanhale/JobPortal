...
const TaxView = () => {
    ...
    const [modale, setModalee] = useState(false);
                    ...
                    <Col lg={12}>
                        <Card id="orderList">
                            ...
                            <CardBody className="pt-0">
                                ...
                                {
                                    modalState === true ? <TaxAdd modalState={modalState} setModalState={() => { setModalState(false) }} /> : ""
                                }
                                {
                                    UpdatemodalState === true ? <TaxUpdate taxname={TaxData.tax_name} taxpercentage={TaxData.tax_percentage} modalState={UpdatemodalState} setModalState={() => { setUpdateModalState(false) }} /> : ""
                                }
